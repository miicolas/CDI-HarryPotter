...
export async function validateSignup(req, res, next) {
    const { username_signup, password_signup, password_signup_confirm, email_signup } = req.body

    if (!(username_signup && password_signup && password_signup_confirm && email_signup)) {
